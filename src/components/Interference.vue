        ...
        <v-col xs="12" sm="6">
          <v-card>
            ...
            <v-card-actions class="ml-4">
              ...
              <v-spacer></v-spacer>
              <v-btn icon @click="laser_show = !laser_show">
          ...
          <v-card>
            ...
            <v-card-actions class="ml-4">
              ...
              ></v-slider>
              <v-spacer></v-spacer>
              <v-btn icon @click="gain_show = !gain_show">
          ...
          <v-card>
            ...
            <v-btn-toggle rounded class="ml-4">
              <v-btn @click="setCommand('device_0', 'SLIT|LEFT')">
                <font-awesome-icon icon="angle-left" />Left
              </v-btn>
              <v-btn variant="info" @click="setCommand('device_0', 'SLIT|RIGHT')">
                <font-awesome-icon icon="angle-right" />Right
              </v-btn>
            </v-btn-toggle>
            ...
            <v-card>
              ...
              <v-card-actions class="ml-4">
                ...
                <v-spacer></v-spacer>
                <v-btn icon @click="step_show = !step_show">
            ...
            <v-btn-toggle rounded class="ml-4">
              <v-btn @click="setCommand('device_0', 'DISTANCE|INCREASE');loop_flag= true;">
                <font-awesome-icon icon="angle-up" />Increase
              </v-btn>
              <v-btn
                variant="info"
                @click="setCommand('device_0', 'DISTANCE|DECREASE');loop_flag= true;"
              >
                <font-awesome-icon icon="angle-down" />Decrease
              </v-btn>
            </v-btn-toggle>
